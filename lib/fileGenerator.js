...
const createFirstTemplates = async () => {
...
const copyFile = async (origin, dest, ovrw) => {
...
const readOriginFile = async (origin) => {
...
const writeDestinyFile = async (dest, data, silent = false) => {
...
const copyFiles = async (from, to, msg1, msg2, silent = false) => {
    perf = performance.now()
